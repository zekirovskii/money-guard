...
import { selectTransactions, selectTransactionCategories } from '../../redux/transactions/selectors';
  ...
  const statistics = useMemo(() => {
    ...
    filteredTransactions.forEach((transaction) => {
      if (transaction.type === 'INCOME') {
        ...
        // Kategori adını bul
        const categoryName = categoryMap[transaction.categoryId] || 'Other expenses';
        ...
        <div className={styles.chartSection}>
          <div className={styles.chartContainer}>
            ...
            <div className={styles.chartCenter}>
              <div className={styles.balanceText}>₹ {statistics.balance.toLocaleString('en-IN', { minimumFractionDigits: 2 })}</div>
            </div>
          </div>
        </div>
          ...
          <div className={styles.summaryTotals}>
            <div className={styles.summaryItem}>
              ...
              <span className={styles.summaryValue}>
                ₹{statistics.totalExpense.toLocaleString('en-IN', { minimumFractionDigits: 2 })}
              </span>
            </div>
            <div className={styles.summaryItem}>
              <span className={styles.summaryLabel}>Income:</span>
              <span className={`${styles.summaryValue} ${styles.income}`}>
                ₹{statistics.totalIncome.toLocaleString('en-IN', { minimumFractionDigits: 2 })}
              </span>
            </div>
          </div>
        </div>
